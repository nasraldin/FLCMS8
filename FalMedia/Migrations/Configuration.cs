    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AppDbContext>
    {
        ...
        protected override void Seed(AppDbContext context)
        {
            context.Links.AddOrUpdate(
                l => l.LinkName,
                new Link {LinkName = "Facebook", LinkUrl = "https://fb.com/", LinkTarget = 0},
                new Link {LinkName = "Twitter", LinkUrl = "https://twitter.com/", LinkTarget = 0},
                new Link {LinkName = "Instagram", LinkUrl = "https://instagram.com/", LinkTarget = 0},
                new Link {LinkName = "Youtube", LinkUrl = "https://youtube.com/", LinkTarget = 0},
                new Link {LinkName = "Linkedin", LinkUrl = "https://linkedin.com/", LinkTarget = 0}
            );
            ...
            context.Settings.AddOrUpdate(
                ...
                new Settings
                {
                    SiteTitle = "Fal Media Offical Website",
                    Tagline = "فالك خير",
                    SiteLogo = "falmedia-logo.svg",
                    EmailAddress = "info@falmedia.sa",
                    PhoneNumber = "92001 9559",
                    Mobile = "+966 555 ‭35 0043",
                    Address = "P.O.Box 4900 - Riyadh 11412",
                    SiteLanguage = "en-us",
                    GoogleMap =
                        "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3623.9635391442193!2d46.66601121553925!3d24.72813198411639!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e2f1d4c87bd9583%3A0xe603d4a12c9664f5!2sFALCOM+Financial+Services!5e0!3m2!1sen!2ssa!4v1480498609769"
                });
            ...
            context.Resources.AddOrUpdate(
                ...
                new Resource {Culture = "ar", Name = "Web", Value = "تطوير المواقع"},
                ...
                new Resource {Culture = "ar", Name = "Media", Value = "الإنتاج الاعلامي"},
                new Resource {Culture = "en-us", Name = "Events", Value = "Events"},
                new Resource {Culture = "ar", Name = "Events", Value = "الفعاليات"},
                new Resource {Culture = "en-us", Name = "Execution", Value = "Execution"},
                new Resource {Culture = "ar", Name = "Execution", Value = "المعارض"},
                new Resource {Culture = "en-us", Name = "Gift", Value = "Gift"},
                new Resource {Culture = "ar", Name = "Gift", Value = "الهدايا"},
