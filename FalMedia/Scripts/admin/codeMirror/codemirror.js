...
(function(mod) {
                ...
                runInOp(cm,
                    function() {
                        ...
                        if (self.composing) {
                            ...
                            self.composing.range = cm.markText(self.composing.start,
                                cm.getCursor("to"),
    ...
    function locateNodeInLineView(lineView, node, offset) {
        ...
        for (var after = topNode.nextSibling, dist = textNode ? textNode.nodeValue.length - offset : 0;
            after;
