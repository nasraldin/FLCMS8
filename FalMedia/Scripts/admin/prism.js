...
var Prism = function() {
        ...
        t = self.Prism = {
            ...
            languages: {
                ...
                insertBefore: function(e, n, a, r) {
                    ...
                    return t.languages.DFS(t
                        .languages,
                        function(t, n) { n === r[e] && t != e && (this[t] = s) }), r[e] = s;
                },
                DFS: function(e, n, a) {
                    for (var r in e)
                        e.hasOwnProperty(r) &&
            ...
            highlightElement: function(a, r, i) {
                ...
                if (o && (l = (o.className.match(e) || [, ""])[1], s = t.languages[l]), s) {
                    a.className = a.className
                        ...
                        .replace(/\s+/g, " ") +
                        " language-" +
                        l, o = a.parentNode, /pre/i.test(o.nodeName) &&
                    ...
                    if (g) {
                        ...
                        if (t.hooks.run("before-highlight", u), r && self.Worker) {
                            ...
                            c.onmessage = function(e) {
                                u.highlightedCode = n.stringify(JSON.parse(e.data), l), t.hooks
                                    .run("before-insert", u), u.element
                                    .innerHTML = u.highlightedCode, i && i.call(u.element), t.hooks
                                    .run("after-highlight", u);
                            }, c.postMessage(JSON.stringify({ language: u.language, code: u.code }));
                        } else
                            u.highlightedCode = t.highlight(u.code, u.grammar, u.language), t.hooks
                                .run("before-insert", u), u.element.innerHTML = u.highlightedCode, i && i.call(a), t
                                .hooks
                                .run("after-highlight", u);
                    }
                }
                ...
                e:for (var l in n)
                    if (n.hasOwnProperty(l) && n[l]) {
                        ...
                        for (var o = 0; o < s.length; ++o) {
                            var g = s[o], u = g.inside, c = !!g.lookbehind, f = 0, h = g.alias;
                            g = g.pattern || g;
    ...
    if (n.stringify = function(e, a, r) {
        ...
        ) return e.map(function(t) { return n.stringify(t, a, e) }).join("");
        var i = {
            type: e.type,
...
Prism.languages.markup = {
    ...
    .add("wrap", function(t) { "entity" === t.type && (t.attributes.title = t.content.replace(/&amp;/, "&")) });;
Prism.languages.css = {
    comment: /\/\*[\w\W]*?\*\//g,
...
Prism.languages.scss = Prism.languages.extend("css",
{
    ...
    }), Prism.languages.insertBefore("scss", "property", { variable: /((\$[-_\w]+)|(#\{\$[-_\w]+\}))/i }), Prism
    .languages
    .insertBefore("scss",
        "ignore",
        {
...
}), Prism.languages.insertBefore("bash", "keyword", { property: /\$([a-zA-Z0-9_#\?\-\*!@]+|\{[^}]+\})/g }), Prism
    .languages.insertBefore("bash", "comment", { important: /(^#!\s*\/bin\/bash)|(^#!\s*\/bin\/sh)/g });;